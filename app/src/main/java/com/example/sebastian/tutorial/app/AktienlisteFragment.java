package com.example.sebastian.tutorial.app;
...
public class AktienlisteFragment extends Fragment{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_test) {
            Toast.makeText(getActivity(), "Testfunktion gedrückt!", Toast.LENGTH_LONG).show();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayAdapter <String> aktienlisteAdapter =
                new ArrayAdapter<>(
                        ...
                        R.id.list_item_aktienliste_textview, // ID des TextViews; wurde in der XML definiert
